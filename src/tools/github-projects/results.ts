...
export function createPermissionError(operation: string): CallToolResult {
    return createErrorResult(`Permission denied: Unable to ${operation}.`, {
        suggestion: "Ensure your GitHub token has 'project' scope permissions.",
        howToFix:
            "Run 'gh auth refresh -s project' to add project permissions to your token.",
    })
}
...
export function createFieldNotFoundError(
    ...
    return createErrorResult(`Field '${fieldName}' not found in project.`, {
        availableFields,
