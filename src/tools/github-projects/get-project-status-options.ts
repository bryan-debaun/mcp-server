...
const toolConfig = {
    ...
    description:
        'Return all available Status column option names for a GitHub Projects V2 board. Use this before setting a Status field value so you know the exact valid option names.',
        ...
        async (args: any): Promise<CallToolResult> => {
            try {
                ...
                const statusField = fields.find(
                    (f) =>
                        f.name === 'Status' && f.dataType === 'SINGLE_SELECT',
                )
