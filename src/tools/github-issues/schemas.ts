...
export const CreateIssueInputSchema = {
    ...
    body: z
        .string()
        .optional()
        .describe('Issue body/description (Markdown allowed)'),
    bodyFile: z
        .string()
        .optional()
        .describe('Path to a Markdown file to use as the issue body'),
    bodyJson: z
        .any()
        .optional()
        .describe('JSON payload to convert to Markdown for the issue body'),
    labels: z.string().optional().describe('Comma-separated labels to add'),
    assignees: z
        .string()
        .optional()
        .describe('Comma-separated GitHub usernames to assign to the issue'),
    milestone: z
        .number()
        .int()
        .positive()
        .optional()
        .describe('Milestone number to assign to the issue'),
}
...
export const UpdateIssueInputSchema = {
    ...
    removeLabels: z
        .string()
        .optional()
        .describe('Comma-separated labels to remove from the issue'),
    assignees: z
        .string()
        .optional()
        .describe('Comma-separated GitHub usernames to assign to the issue'),
    milestone: z
        ...
        .positive()
        .optional()
        .describe('Milestone number to assign (use 0 to clear)'),
    state: z
        .enum(['open', 'closed'])
        .optional()
    ...
    stateReason: z
        ...
        .optional()
        .describe(
            'Reason for closing: completed or not_planned (ignored when opening)',
        ),
